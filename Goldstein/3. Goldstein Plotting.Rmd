...
library(scales)
library(dplyr)
source(here::here("desktop/ww_paper-1/src/wastewater_functions2.R"))
sim = "real"
seed = 1
...
```{r}
gq_address <- paste0("ww_paper-1/vignettes3/generated_quantities_scenario", 
                     sim, 
                     "_seed", 
                     seed,
                     ".csv")
...
```{r}
post_pred_address <- paste0("ww_paper-1/vignettes3/posterior_predictive_scenario",
                            sim,
                            "_seed",
                            seed,
                            ".csv")
